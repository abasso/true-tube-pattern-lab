  ...
  "comments" : [
    {
      ...
      "title" : "Masthead",
      "comment": "The main header of the site includes a call to action to prompt users to either login or sign up."
    },
    {
      "el": ".c-logo-link",
      "title" : "Logo",
      "comment": "The logo image is an SVG file, which ensures that the logo displays crisply even on high resolution displays."
    },
    {
      "el": "#nav",
      "title" : "Navigation",
      "comment": "The navigation includes both primary and secondary navigation which collapse down into a burger menu on smaller devices. The search is hidden on desktop and visible within the burger menu panel on mobile. This is to acommodate more menu items should they be added in the future."
    },
    {
      "el": ".c-search-form",
      "title" : "Search",
